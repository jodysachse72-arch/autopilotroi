      ...
      content: [
        {
          ...
          props: {
            ...
            lead: 'Aurum Foundation has built a complete financial infrastructure stack. AutoPilotROI is your onboarding partner for all of it.',
            align: 'center',
            badgeVariant: 'blue',
          },
        },
      ...
      content: [
        {
          ...
          props: {
            ...
            title: 'Real people. Real returns.',
            lead: '',
            align: 'center',
            badgeVariant: 'white',
          },
...
async function seedHome() {
  console.log('Inserting Puck data directly into Supabase for / ...')
  ...
  if (error) {
    ...
    console.log('Success! The / route is now powered by Puck.')
  }
}
