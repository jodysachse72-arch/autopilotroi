    ...
    <div className="min-h-screen bg-[#06122f]">
      <div className="relative overflow-hidden border-b border-white/10 bg-[linear-gradient(180deg,#0b1f57_0%,#06122f_100%)] px-6 py-16 lg:px-10">
        ...
        <div className="relative mx-auto max-w-3xl text-center">
          <h1 className="font-[var(--font-sora)] text-4xl font-bold text-white">Terms of Service</h1>
          <p className="mt-4 text-blue-100/60">Last updated: April 12, 2026</p>
        </div>
      </div>

      <div className="mx-auto max-w-3xl px-6 py-16 lg:px-10">
        <div className="prose prose-invert prose-blue max-w-none space-y-8 text-blue-100/70 [&_h2]:text-white [&_h2]:font-[var(--font-sora)] [&_h2]:text-xl [&_h2]:font-bold [&_h2]:mt-10 [&_h2]:mb-4 [&_h3]:text-white [&_h3]:font-semibold [&_h3]:mt-6 [&_h3]:mb-2 [&_strong]:text-white [&_a]:text-blue-400 [&_a]:underline">
