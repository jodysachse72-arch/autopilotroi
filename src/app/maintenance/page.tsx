    ...
    <div className="relative flex min-h-screen items-center justify-center overflow-hidden bg-[#06122f]">
      ...
      <div className="relative z-10 mx-auto max-w-lg px-6 text-center">
        ...
        <motion.div
          ...
          className="mx-auto mb-8 flex h-24 w-24 items-center justify-center rounded-full border border-white/10 bg-white/[0.03]"
        >
        ...
        <motion.h1
          ...
          className="font-[var(--font-sora)] text-4xl font-bold text-white"
        >
          We&apos;re Upgrading
        </motion.h1>
        ...
        <motion.p
          ...
          className="mt-4 text-lg text-blue-100/50"
        >
        ...
        >
          <div className="rounded-xl border border-white/5 bg-white/[0.02] px-6 py-4">
            <div className="text-xs uppercase tracking-wider text-white/30 mb-1">Expected Duration</div>
            <div className="text-lg font-semibold text-white">Less than 30 minutes</div>
          </div>
