...
/* ΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉ
   ADMIN DASHBOARD ΓÇö at-a-glance overview.
   Refactored onto backend primitives so style lives in CSS, not
   inline classes against non-existent CSS variables.
   ΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉ */

const systemStats = [
  { label: 'Total Users',            value: '142', delta: '+12 this week',  trend: 'up' as const,   icon: '≡ƒæÑ' },
  { label: 'Active Partners',        value: '23',  delta: '+3 this month',  trend: 'up' as const,   icon: '≡ƒñ¥' },
  { label: 'Pending Prospects',      value: '8',   delta: '5 unassigned',   trend: 'flat' as const, icon: 'ΓÅ│' },
  { label: 'Completed Onboardings',  value: '97',  delta: '68% conversion', trend: 'up' as const,   icon: 'Γ£à' },
]
  ...
  return (
    <div className="mx-auto max-w-6xl space-y-6">
      ...
      <div className="grid gap-4 lg:grid-cols-2">
        ...
        <Card padding="flush">
          <SectionHeader
            title="ΓÜá∩╕Å Unassigned Prospects"
            actions={
              <a
