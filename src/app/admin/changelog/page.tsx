...
const changelog: ChangeEntry[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { title: 'Password Strength Meter', description: 'Visual 3-bar indicator (weak/medium/strong) with improvement hints. Added to reset password page.', type: 'feature', files: ['src/components/ui/PasswordStrengthMeter.tsx', 'src/app/(auth)/reset-password/page.tsx'] },
      { title: 'Breadcrumb Navigation', description: 'Auto-generating breadcrumbs from route path. Added to both dashboard and admin layouts for all sub-pages.', type: 'feature', files: ['src/components/ui/Breadcrumbs.tsx', 'src/app/dashboard/layout.tsx', 'src/app/admin/layout.tsx'] },
      { title: 'Command Palette (Cmd+K)', description: 'Keyboard-activated search across all pages. Fuzzy filtering, arrow-key navigation, category badges. Works in both dashboard and admin.', type: 'feature', files: ['src/components/ui/CommandPalette.tsx'] },
      { title: 'Notification Center', description: 'Bell icon in dashboard header with unread badge and dropdown panel showing recent activity.', type: 'feature', files: ['src/app/dashboard/layout.tsx'] },
      { title: 'Remember Me Checkbox', description: 'Added to login page between forgot password link and submit button. Defaults to checked.', type: 'improvement', files: ['src/app/(auth)/login/page.tsx'] },
      { title: 'Invite a Partner Link', description: 'Added ➕ Invite a Partner shortcut in user dropdown menu.', type: 'improvement', files: ['src/components/layout/Navbar.tsx'] },
      { title: 'Partner Onboarding Wizard', description: '3-step welcome card for new partners: Set Up Profile → Share First Link → Watch Training. Progress tracking, auto-dismiss after completion.', type: 'feature', files: ['src/components/ui/PartnerOnboardingWizard.tsx', 'src/app/dashboard/page.tsx'] },
      { title: 'Per-Page SEO Metadata', description: 'Unique OG titles and descriptions for FAQs, Products, Calculator, Evaluate, Media, and Blog pages.', type: 'improvement', files: ['src/app/faqs/layout.tsx', 'src/app/products/layout.tsx', 'src/app/calculator/layout.tsx', 'src/app/evaluate/layout.tsx', 'src/app/media/layout.tsx', 'src/app/blog/layout.tsx'] },
      { title: 'Partner Welcome Email API', description: 'POST /api/partner/welcome — branded HTML email template with referral code, login link, quick-start steps. Demo mode compatible.', type: 'feature', files: ['src/app/api/partner/welcome/route.ts'] },
