...
import {
  LayoutDashboard, Users, Search, Flag, Map, FileText,
  CheckSquare, BookOpen, Library, ClipboardList, Settings2,
  Mail, Menu,
} from 'lucide-react'
...
const sidebarLinks: SidebarLink[] = [
  ...
  { id: 'admin-prospects',  label: 'Prospects',       href: '/admin/prospects',   icon: Search },
  { id: 'admin-cms',        label: 'Content Editor',  href: '/admin/cms',         icon: FileText },
  { id: 'admin-emails',     label: 'Emails',          href: '/admin/emails',      icon: Mail },
  { id: 'admin-features',   label: 'Feature Flags',   href: '/admin/features',    icon: Flag },
  ...
  { id: 'admin-settings',   label: 'Integrations',    href: '/admin/settings',    icon: Settings2 },
]
