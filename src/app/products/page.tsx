...
import { StaticWhatIsAurumPage } from './StaticProductsPage'
...
export default async function WhatIsAurumPage() {
  const puckData = await getPuckData('/products')
